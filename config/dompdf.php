...
return [
    ...
    */
    ...
    'options' => [
         ...
         *
         * Enabled for PDF size optimization - reduces font file size by including
         * only the characters used in the document
         */
         ...
         * @var int
         *
         * Reduced to 72 for PDF size optimization (from 96)
         */
        'dpi' => 72,
