...
<table style="undefined;table-layout: fixed; width: 620px; margin-left: 47px; margin-top: -48px;">
    ...
    <table class="tg" style="undefined;table-layout: fixed; width: 620px; margin-left: 47px; margin-top: 20px;">
        ...
        <tbody>
            @php
                ...
                $tanggal = $result->start_date ? Carbon::parse($result->date) : null;
                ...
                $tanggal = $result->end_date ? Carbon::parse($result->end_date) : null;
                $hariIDend = $tanggal ? $tanggal->translatedFormat('l') : '-';
                $hariENend = $tanggal ? $tanggal->locale('en')->translatedFormat('l') : '-';
                $tanggalIDend = $tanggal ? $tanggal->translatedFormat('d F Y') : '-';
                $tanggalENend = $tanggal ? $tanggal->locale('en')->translatedFormat('F jS Y') : '-';
            @endphp
            <tr>
    ...
    <div style="margin-top: 55px;margin-left: 16px;position:absolute;width: 720px">
        <small>
            <span style="color:coral;"><b>A: </b></span><span
                style="font-weight: lighter;">{{ $result->outlet->address }}</span> | <span
                style="color:coral;"><b>P:</b></span> <span
                style="font-weight: lighter;">{{ $result->outlet->phone }} </span> <span
                style="color:coral;"><b>E:</b></span> <span
                style="font-weight: lighter;">{{ $result->outlet->user->email }}</span>
            </small>
    </div>
