...
<head>
    ...
    <style>
        ...
        /* Anda bisa tambahkan kelas 'active' pada link yang aktif */
        /* .nav-link.active { 
            ...
            <div class="p-4 border-t border-slate-200/80">
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" @click.away="open = false"
                         ...
                         class="absolute bottom-full left-0 mb-2 w-full bg-white border border-slate-200 rounded-lg shadow-xl z-50 p-2 text-sm space-y-1" style="display: none;">
            ...
            <header class="w-full bg-white/80 backdrop-blur-xl px-6 py-3 flex justify-between items-center border-b border-slate-200/80 z-10 ring-1 ring-black/5">
                ...
                <div class="flex items-center space-x-5">
                    @php
                        ...
                        $maxSessions = 3;
                    @endphp
                    <a href="#" class="flex items-center space-x-2 px-2 py-1 rounded-lg hover:bg-white/50 transition">
