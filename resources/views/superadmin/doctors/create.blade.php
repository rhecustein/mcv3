...
<div class="max-w-2xl mx-auto">
    ...
    <h1 class="text-2xl font-bold text-gray-800 mb-6">➕ Tambah Dokter Baru</h1>

    <form action="{{ route('doctors.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow space-y-6">
        @csrf
        ...
        <div class="text-sm text-gray-500">
            🔐 Password default akan diset ke: <code>doctor123</code>
        </div>
