...
<div class="bg-white p-6 sm:p-8 rounded-2xl shadow-lg" x-data="{ view: 'grid' }">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-6 border-b border-slate-200">
        ...
        <div class="flex items-center gap-3 flex-shrink-0">
            ...
            <a href="{{ route('template-results.create') }}" class="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 transition-all duration-200">
    ...
    <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
        ...
        <form method="GET" class="md:col-span-2 bg-slate-50 border border-slate-200 rounded-xl p-4 flex flex-col sm:flex-row gap-4 items-center">
            ...
            <a href="{{ route('template-results.index') }}" class="w-full sm:w-auto text-center px-4 py-2 bg-slate-200 text-slate-700 rounded-md text-sm font-medium hover:bg-slate-300 transition">Reset</a>
        </form>
    </div>
