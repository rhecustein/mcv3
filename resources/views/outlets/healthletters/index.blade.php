            ...
            <table class="min-w-full text-sm">
                <thead class="bg-slate-50 text-xs uppercase text-slate-500 tracking-wider">
                    <tr>
                        ...
                        <th class="px-6 py-3 font-medium text-center">Jenis Surat</th>
                ...
                <tbody class="divide-y divide-slate-200">
                    @forelse ($results as $result)
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="font-semibold text-slate-800">{{ \Carbon\Carbon::parse($result->date)->format('d M Y') }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="font-semibold text-slate-800">{{ $result->type }}</div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                ...
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    @if(in_array($result->type, ['mc', 'skb']) && $result->document_name)
                                        ...
                                        class="p-2 text-slate-500 bg-slate-100 rounded-md hover:bg-slate-200 hover:text-blue-600 transition" title="Lihat Preview">
                                        ...
                                        class="p-2 text-slate-500 bg-slate-100 rounded-md hover:bg-slate-200 hover:text-green-600 transition" title="Download PDF">
                                    ...
                                    <a href="#" {{-- Ganti # dengan route edit yang benar --}}
                                    class="p-2 text-slate-500 bg-slate-100 rounded-md hover:bg-slate-200 hover:text-amber-600 transition" title="Edit Surat">
                                    ...
                                    <form method="POST" action="{{ route('outlet.results.' . $result->type . '.delete', $result->id) }}" onsubmit="return confirm('Yakin ingin menghapus surat ini?')" class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                                class="p-2 text-slate-500 bg-slate-100 rounded-md hover:bg-red-100 hover:text-red-600 transition" title="Hapus Surat">
