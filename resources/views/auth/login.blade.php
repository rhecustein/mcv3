...
<head>
    ...
    <style>
        ...
        /* [NEW] Shake Animation for Failed Login */
        .shake {
...
<body class="min-h-screen font-sans antialiased text-slate-800">
    ...
    {{-- [NEW] Alert Container (Fixed Position) --}}
                ...
                <div id="login-card" class="bg-white/70 backdrop-blur-xl border border-slate-200/80 shadow-2xl rounded-2xl p-8">
                    ...
                    <div id="login-form-state" class="hidden animate-fade-in-up">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-6" id="login-form">
                            ...
                            <button type="submit" id="login-btn" class="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg shadow-lg shadow-blue-500/30 transition-all duration-300 transform hover:scale-105">
                                Masuk
                            </button>
                        </form>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // [NEW] Check for server-side errors and show alerts
            @if ($errors->any())
            ...
            // [NEW] Check for success messages
            @if (session('status'))
            ...
            // [NEW] Enhanced Form Submission with Loading State
            loginForm.addEventListener('submit', function(e) {
                ...
                // Optional: Add timeout to remove loading state if form doesn't submit
                setTimeout(() => {
